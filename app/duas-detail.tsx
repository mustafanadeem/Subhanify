...
export default function DuasDetailScreen() {
  ...
  const duasList = useMemo(() => getDuasByCategory(categoryKey), [categoryKey]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.headerTitleContainer}>
          <ThemedText style={styles.headerTitle}>Duas</ThemedText>
        </View>
      ...
      <View style={styles.contentWrapper}>
        ...
        >
          {duasList.map((dua, index) => (
            <View key={dua.id} style={styles.page}>
              <ScrollView
